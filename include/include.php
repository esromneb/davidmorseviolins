...
$menuImg = array("presentation.gif", "instruments.gif", "gallery.gif","interview.gif","stringsarticle.jpg","endorsements.gif");
$menuA = array("presentation.php", "instruments.php", "gallery.php", "interview.php", "stringsarticle.php","endorsements.php");
